...
print(my_list[0:2]) # Gives us elements at indices 0, 1 (2 is exclusive)
print(my_list[-2:])
print(my_list [0:]) # Both of these print the whole sequence
print(my_list [:])# There is an 'implicit' start and stop index, namely the first and last elements of the sequence.

# You can also specify a step for the slice
print(my_list [0:5:2]) # Step of 2
...
print(d.get('grape', 'default'))# Doesn't crash, unlike d['grape']

print(d.pop('blueberry')) # Removes an element by key
...
a = set()
a = {1, 2, 3, 4}
print(a.add(4)) # This will not do anything, since 4 is already a member of the set.
